<header class="vironeer-page-header">
    ...
    <div class="button">
        <a href="{{ url('/') }}" target="_blank" class="btn btn-outline-primary rounded-50"><i
    ...
    <div class="vironeer-user-menu">
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            <li><a class="dropdown-item" href="{{ route('admin.account.details') }}"><i
                        class="fa fa-user me-2"></i>{{ __('Personal details') }}</a></li>
            <li><a class="dropdown-item" href="{{ route('admin.account.security') }}"><i
                        class="fas fa-sync me-2"></i>{{ __('Change password') }}</a></li>
            <li>
