...
@section('section', lang('Password', 'video password'))
                        ...
                        <div class="file-password">
                            ...
                            <div class="file-password-form">
                                <form action="{{ route('file.password', $fileEntry->shared_id) }}" method="POST">
                                    @csrf
                                    <label
                                        class="form-label mb-3">{{ lang('Enter the password to unlock the video', 'video password') }}
                                    </label>
                                    <div class="input-group input-icon input-password mb-3">
                                        <input type="password" name="password" class="form-control form-control-md"
                                            placeholder="{{ lang('Enter password', 'video password') }}" required>
                                        <button type="button" id="input-group-button-right">
                                            <i class="fa fa-eye"></i>
                                        </button>
                                    </div>
                                    <button
                                        class="btn btn-primary btn-md w-100">{{ lang('Unlock', 'video password') }}</button>
                                </form>
                            </div>
                        </div>
                    </div>
